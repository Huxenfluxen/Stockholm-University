...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 20 20:53:17 2021
...
class Cell:
    ...
    def neighbors(self):
        ...
        neig_cords = [Cell((cords[0] - 1),(cords[1] - 1)),Cell((cords[0] - 1),(cords[1])),Cell((cords[0] - 1),(cords[1] + 1)),
                      Cell((cords[0]),(cords[1] - 1)),Cell((cords[0]),(cords[1] + 1)),
                      Cell((cords[0] + 1),(cords[1] - 1)),Cell((cords[0] + 1),(cords[1])), Cell((cords[0] + 1),(cords[1] + 1))]
...
def update(world):
    ...
    for c in counter:
        if c in world and (counter[c] == 2 or counter[c] == 3):
            result[c] = True
        elif counter[c] == 3:
            result[c] = True
